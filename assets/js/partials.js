...
<header class="site-header">
  <div class="container header-inner">
    <button class="hamburger" aria-label="Open menu"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M3 7h18M3 12h18M3 17h18"/></svg></button>
    <a href="{ROOT}index.html" class="logo"><img src="{ROOT}assets/img/logo.png" alt="The Curl Co" width="120" height="38"></a>
    <nav class="nav" aria-label="Primary">
      <ul class="nav-list">
        <li><a href="{ROOT}shop.html">Shop</a>
        ...
        <li><a href="{ROOT}blog.html">Edit</a></li>
        <li><a href="{ROOT}about.html">Story</a></li>
      </ul>
    </nav>
    <div class="icon-actions">
      <a class="icon-btn open-search" href="#" aria-label="Search"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="11" cy="11" r="7"/><path d="m20 20-3.5-3.5"/></svg></a>
      <a class="icon-btn" href="{ROOT}account.html" aria-label="Account"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/></svg></a>
      <a class="icon-btn" href="{ROOT}account.html#wishlist" aria-label="Wishlist"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></a>
      <a class="icon-btn open-cart" href="#" aria-label="Cart"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M6 6h15l-1.5 9h-12z"/><circle cx="9" cy="20" r="1.5"/><circle cx="18" cy="20" r="1.5"/><path d="M6 6 4 2H2"/></svg><span class="cart-badge cart-count" style="display:none">0</span></a>
    </div>
  </div>
</header>
<aside class="mobile-nav">
  ...
  <a href="{ROOT}shop.html">Shop</a><a href="{ROOT}bundles.html">Bundles</a><a href="{ROOT}routine-quiz.html">Curl Quiz</a><a href="{ROOT}blog.html">The Edit</a><a href="{ROOT}about.html">Our Story</a><a href="{ROOT}reviews.html">Reviews</a><a href="{ROOT}faq.html">FAQs</a><a href="{ROOT}contact.html">Contact</a>
</aside>
...
<footer class="site-footer">
  <div class="container">
    <div class="footer-wordmark">The Curl <em>Co.</em></div>
    <div class="footer-grid">
      <div class="footer-brand">
        <a href="{ROOT}index.html" class="logo"><img src="{ROOT}assets/img/logo.png" alt="The Curl Co" style="height:38px;filter:invert(1) brightness(2)"></a>
        <p>India's curly hair authority. Sulphate-free, silicone-free curl care for 2A through 4A textures. Made in Mumbai with monsoon-proof love.</p>
        <div class="socials">
          <a href="https://instagram.com/thecurlco" aria-label="Instagram"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor"/></svg></a>
...
<nav class="tab-bar">
  <a href="{ROOT}index.html"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M3 11l9-8 9 8v10a1 1 0 0 1-1 1h-5v-7H9v7H4a1 1 0 0 1-1-1z"/></svg>Home</a>
  <a href="{ROOT}shop.html"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><path d="M3 6h18"/></svg>Shop</a>
  <a href="{ROOT}routine-quiz.html"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="12" cy="12" r="9"/><path d="M9.1 9a3 3 0 0 1 5.8 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>Quiz</a>
  <a href="#" class="open-cart"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M6 6h15l-1.5 9h-12z"/><circle cx="9" cy="20" r="1.5"/><circle cx="18" cy="20" r="1.5"/></svg>Cart</a>
  <a href="{ROOT}account.html"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/></svg>Account</a>
</nav>`;
  ...
  function onScroll(){
    ...
    if(!h) return;
    if(window.scrollY > 60) h.classList.add('is-scrolled');
